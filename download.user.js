...
(function() {
    ...
    function createDownloadButton(data) {
        ...
        waitForElm(".player__controls-bottom__item.player-report button").then((elm) => {
            newButton.download = `${document.getElementsByClassName('player__title shrink flex-box align-middle')[0].innerHTML} - ${document.getElementsByClassName('player__title-sub')[0].innerHTML}.vtt`;
